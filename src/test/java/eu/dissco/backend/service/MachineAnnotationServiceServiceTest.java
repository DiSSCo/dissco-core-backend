...
class MachineAnnotationServiceServiceTest {
  ...
  private static Stream<Arguments> provideFilters() {
    return Stream.of(
        ...
        Arguments.of(List.of(
            Pair.of("$['dcterms:format']", List.of("application/json")),
            Pair.of("$['digitalSpecimen']['ods:hasEvent'][*]['Location']['dwc:country']",
                List.of("The Netherlands", "Belgium")))),
        Arguments.of(List.of(
            Pair.of("$['dcterms:format']", List.of("application/json")),
            Pair.of("$['digitalSpecimen']['ods:hasEvent'][*]['Location']['dwc:city']",
  ...
  private static OdsTargetDigitalObjectFilter givenFiltersDigitalMedia(
