...
public class SpecimenUtils {
	...
	public static List<JsonApiData> givenDigitalSpecimenJsonApiData(List<DigitalSpecimen> digitalSpecimenList) {
		List<JsonApiData> dataNode = new ArrayList<>();
		digitalSpecimenList
			.forEach(specimenWrapper -> dataNode.add(new JsonApiData(specimenWrapper.getDctermsIdentifier(),
					FdoType.DIGITAL_SPECIMEN.getName(), MAPPER.valueToTree(specimenWrapper))));
		return dataNode;
	}

	public static JsonApiData givenDigitalSpecimenJsonApiData(DigitalSpecimen specimenWrapper) {
	...
	public static List<JsonApiData> givenDigitalSpecimenJsonApiDataList(int qty) {
		...
		List<JsonApiData> dataNode = new ArrayList<>();
		digitalSpecimen.forEach(s -> dataNode
			.add(new JsonApiData(s.getDctermsIdentifier(), FdoType.DIGITAL_SPECIMEN.getName(), MAPPER.valueToTree(s))));
		return dataNode;
	}
