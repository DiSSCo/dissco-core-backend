...
public class DigitalMediaObjectUtils {
	...
	public static DigitalMedia givenDigitalMediaObject(String mediaId, String specimenId, int version) {
		return givenDigitalMediaObjectData(mediaId, version, specimenId);
	}

	// JsonApiData
	public static JsonApiData givenDigitalMediaJsonApiData(String id) {
		var mediaObject = givenDigitalMediaObject(id);
		return new JsonApiData(mediaObject.getDctermsIdentifier(), FdoType.DIGITAL_MEDIA.getName(), mediaObject,
				MAPPER);
	}
	...
	public static JsonApiListResponseWrapper givenDigitalMediaJsonResponse(String path, int pageNumber, int pageSize,
	...
	private static DigitalMedia givenDigitalMediaObjectData(String mediaId, int version, String specimenId) {
		return new DigitalMedia().withId(mediaId)
