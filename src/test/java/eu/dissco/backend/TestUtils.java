...
public class TestUtils {
	...
	public static final String FORBIDDEN_MESSAGE = "User: " + ORCID_ALT + " is not allowed to perform this action";
	...
	public static Agent givenAgent(String userId, String roleName) {
		return new Agent().withType(Type.SCHEMA_PERSON)
			...
			.withOdsHasIdentifiers(List.of(new eu.dissco.backend.schema.Identifier().withType("ods:Identifier")
				.withId(userId)
	...
	public static Map<String, Object> givenClaims() {
		return Map.of("orcid", BARE_ORCID, "given_name", "Sam", "family_name", "Leeflang");
	}

	public static Map<String, Object> givenAdminClaims() {
		return Map.of("orcid", ORCID, "given_name", "Sam", "family_name", "Leeflang", "realm_access",
				Map.of("roles", List.of("dissco-admin")));
	}
	...
	public static DigitalSpecimen givenDigitalSpecimenWrapper(String id, String physicalId, String sourceSystem) {
	...
	public static DigitalSpecimen givenDigitalSpecimenWrapper(String id, String physicalId, Integer version,
	...
	private static DigitalSpecimen givenDigitalSpecimen(String id, String physicalId, Integer version,
		...
		return new eu.dissco.backend.schema.DigitalSpecimen().withId(id)
			...
			.withOdsHasEvents(List.of(new Event().withOdsHasLocation(new Location().withDwcCountry(country))));
	}
	...
	public static DigitalSpecimen givenDigitalSpecimenAltCountry(String id) {
		return givenDigitalSpecimen(id, PHYSICAL_ID, 1, SOURCE_SYSTEM_ID_1, "Alt Country Specimen", "Netherlands");
	}

	public static Map<String, Map<String, Long>> givenAggregationMap() {
		return Map.of("sourceSystem", Map.of(SOURCE_SYSTEM_ID_1, 5L, SOURCE_SYSTEM_ID_2, 5L), "typeStatus",
				Map.of("type", 10L), "hasMedia", Map.of("true", 10L));
	}

	public static Map<String, Map<String, Long>> givenTaxonAggregationMap() {
		return Map.of("phylum", Map.of("Chordata", 3782L));
	}

	public static Agent givenCreator(String userId) {
		return new Agent().withId(userId).withType(Type.SCHEMA_PERSON).withSchemaName("User");
	}
