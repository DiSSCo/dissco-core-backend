...
class DigitalMediaObjectControllerTest {
  ...
  @Test
  void testScheduleMasEmptyOptional() throws Exception {
    // Given
    var expectedResponse = givenMasResponse(DIGITAL_MEDIA_PATH);
    var request = givenMasRequest();
    givenAuthentication();
    ...
    // When
    var result = controller.scheduleMassForDigitalMediaObject(PREFIX, SUFFIX, Optional.empty(), request, authentication, mockRequest);
