...
public abstract class BaseController {
	...
	protected static Agent getAgent(Authentication authentication, String roleName) throws ForbiddenException {
		...
		if (claims.containsKey(ORCID)) {
			...
			return new Agent().withType(Type.SCHEMA_PERSON)
				...
				.withOdsHasIdentifiers(List.of(new Identifier().withId(id)
	...
	protected List<MasJobRequest> getMassRequestFromRequest(MasSchedulingRequest requestBody) throws ConflictException {
