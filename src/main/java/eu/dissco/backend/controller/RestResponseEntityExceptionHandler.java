...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ExceptionResponseWrapper> handleIOException(java.io.IOException e) {
		...
		var exceptionResponse = new ExceptionResponseWrapper(HttpStatus.BAD_GATEWAY, "Bad Gateway",
	...
	public ResponseEntity<ExceptionResponseWrapper> handleException(ConflictException e) {
		...
		var exceptionResponse = new ExceptionResponseWrapper(HttpStatus.CONFLICT, "ID Conflict", message);
	...
	public ResponseEntity<ExceptionResponseWrapper> handleException(NotFoundException e) {
		...
		var exceptionResponse = new ExceptionResponseWrapper(HttpStatus.NOT_FOUND, "Resource Not Found", message);
	...
	public ResponseEntity<ExceptionResponseWrapper> handleException(ForbiddenException e) {
		var exceptionResponse = new ExceptionResponseWrapper(HttpStatus.FORBIDDEN, "Forbidden", e.getMessage());
	...
	public ResponseEntity<ExceptionResponseWrapper> handleException(IllegalArgumentException e) {
		var exceptionResponse = new ExceptionResponseWrapper(HttpStatus.BAD_REQUEST, "Illegal Argument",
				e.getMessage());
	...
	public ResponseEntity<ExceptionResponseWrapper> handleException(UnknownParameterException e) {
		var exceptionResponse = new ExceptionResponseWrapper(HttpStatus.BAD_REQUEST, "Unknown Parameter",
				e.getMessage());
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(exceptionResponse);
	}
	...
	public ResponseEntity<ExceptionResponseWrapper> handleException(InvalidAnnotationRequestException e) {
		var exceptionResponse = new ExceptionResponseWrapper(HttpStatus.BAD_REQUEST, "Invalid Annotation Request",
				e.getMessage());
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(exceptionResponse);
	}
	...
	public ResponseEntity<ExceptionResponseWrapper> handleException(WebProcessingFailedException e) {
		var exceptionResponse = new ExceptionResponseWrapper(HttpStatus.UNPROCESSABLE_CONTENT,
				"Unable to communicate with external service", e.getMessage());
		return ResponseEntity.status(HttpStatus.UNPROCESSABLE_CONTENT).body(exceptionResponse);
	}

	@ResponseStatus(HttpStatus.METHOD_NOT_ALLOWED)
	@ExceptionHandler(UnsupportedOperationException.class)
	public ResponseEntity<ExceptionResponseWrapper> handleException(UnsupportedOperationException e) {
		var exceptionResponse = new ExceptionResponseWrapper(HttpStatus.UNPROCESSABLE_CONTENT,
