...
public class JsonApiUtils {
	...
	public static JsonApiListResponseWrapper wrapListResponse(List<JsonApiData> dataNodePlusOne, int pageSize,
	...
	public static JsonApiListResponseWrapper wrapListResponse(List<JsonApiData> dataNodePlusOne, long totalCount,
