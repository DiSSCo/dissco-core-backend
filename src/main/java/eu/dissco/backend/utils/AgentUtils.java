...
public class AgentUtils {
	...
	public static Agent createAgent(String name, String pid, String roleName, String idTitle, Type agentType) {
	...
	public static Agent createServiceAgent(ApplicationProperties properties) {
		return createAgent(properties.getName(), properties.getPid(), ROLE_NAME_BACKEND, DctermsType.DOI.value(),
				PROV_SOFTWARE_AGENT);
	}
