...
public class NewDigitalMediaObject extends TableImpl<NewDigitalMediaObjectRecord> {
   ...
   */
  public final TableField<NewDigitalMediaObjectRecord, String> ID = createField(DSL.name("id"),
      SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.new_digital_media_object.version</code>.
   */
  public final TableField<NewDigitalMediaObjectRecord, Integer> VERSION = createField(
      DSL.name("version"), SQLDataType.INTEGER.nullable(false), this, "");

  /**
   * The column <code>public.new_digital_media_object.type</code>.
   */
  public final TableField<NewDigitalMediaObjectRecord, String> TYPE = createField(DSL.name("type"),
   ...
   */
  public final TableField<NewDigitalMediaObjectRecord, String> DIGITAL_SPECIMEN_ID = createField(
   ...
   */
  public final TableField<NewDigitalMediaObjectRecord, String> MEDIA_URL = createField(
      DSL.name("media_url"), SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.new_digital_media_object.format</code>.
   */
  public final TableField<NewDigitalMediaObjectRecord, String> FORMAT = createField(
      DSL.name("format"), SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.new_digital_media_object.source_system_id</code>.
   */
  public final TableField<NewDigitalMediaObjectRecord, String> SOURCE_SYSTEM_ID = createField(
   ...
   */
  public final TableField<NewDigitalMediaObjectRecord, Instant> CREATED = createField(
   ...
   */
  public final TableField<NewDigitalMediaObjectRecord, Instant> LAST_CHECKED = createField(
   ...
   */
  public final TableField<NewDigitalMediaObjectRecord, Instant> DELETED = createField(
      DSL.name("deleted"), SQLDataType.INSTANT, this, "");

  /**
   * The column <code>public.new_digital_media_object.data</code>.
   */
  public final TableField<NewDigitalMediaObjectRecord, JSONB> DATA = createField(DSL.name("data"),
      SQLDataType.JSONB, this, "");

  /**
   * The column <code>public.new_digital_media_object.original_data</code>.
   */
  public final TableField<NewDigitalMediaObjectRecord, JSONB> ORIGINAL_DATA = createField(
   ...
   */
  public final TableField<NewDigitalMediaObjectRecord, String> PHYSICAL_SPECIMEN_ID = createField(
      DSL.name("physical_specimen_id"), SQLDataType.VARCHAR.nullable(false)
          .defaultValue(DSL.field(DSL.raw("'unknown'::character varying"), SQLDataType.VARCHAR)),
      this, "");
  ...
  public <O extends Record> NewDigitalMediaObject(Table<O> child,
      ForeignKey<O, NewDigitalMediaObjectRecord> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.asList(Indexes.NEW_DIGITAL_MEDIA_OBJECT_DIGITAL_SPECIMEN_ID_URL,
        Indexes.NEW_DIGITAL_MEDIA_OBJECT_ID_IDX, Indexes.NEW_DIGITAL_MEDIA_OBJECT_ID_VERSION_URL);
  }
  ...
  public <U> SelectField<U> mapping(
      Function13<? super String, ? super Integer, ? super String, ? super String, ? super String, ? super String, ? super String, ? super Instant, ? super Instant, ? super Instant, ? super JSONB, ? super JSONB, ? super String, ? extends U> from) {
