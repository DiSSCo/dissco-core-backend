...
public class MasJobRecord extends TableImpl<MasJobRecordRecord> {
	 ...
	 */
	public final TableField<MasJobRecordRecord, String> JOB_ID = createField(DSL.name("job_id"),
			SQLDataType.CLOB.nullable(false), this, "");

	/**
	 * The column <code>public.mas_job_record.job_state</code>.
	 */
	public final TableField<MasJobRecordRecord, JobState> JOB_STATE = createField(DSL.name("job_state"),
			SQLDataType.VARCHAR.nullable(false).asEnumDataType(JobState.class), this, "");
	 ...
	 */
	public final TableField<MasJobRecordRecord, Instant> TIME_STARTED = createField(DSL.name("time_started"),
			SQLDataType.INSTANT.nullable(false), this, "");

	/**
	 * The column <code>public.mas_job_record.time_completed</code>.
	 */
	public final TableField<MasJobRecordRecord, Instant> TIME_COMPLETED = createField(DSL.name("time_completed"),
			SQLDataType.INSTANT, this, "");

	/**
	 * The column <code>public.mas_job_record.annotations</code>.
	 */
	public final TableField<MasJobRecordRecord, JSONB> ANNOTATIONS = createField(DSL.name("annotations"),
			SQLDataType.JSONB, this, "");

	/**
	 * The column <code>public.mas_job_record.target_id</code>.
	 */
	public final TableField<MasJobRecordRecord, String> TARGET_ID = createField(DSL.name("target_id"),
			SQLDataType.CLOB.nullable(false), this, "");

	/**
	 * The column <code>public.mas_job_record.creator</code>.
	 */
	public final TableField<MasJobRecordRecord, String> CREATOR = createField(DSL.name("creator"), SQLDataType.CLOB,
			this, "");

	/**
	 * The column <code>public.mas_job_record.target_type</code>.
	 */
	public final TableField<MasJobRecordRecord, MjrTargetType> TARGET_TYPE = createField(DSL.name("target_type"),
			SQLDataType.VARCHAR.asEnumDataType(MjrTargetType.class), this, "");

	/**
	 * The column <code>public.mas_job_record.batching_requested</code>.
	 */
	public final TableField<MasJobRecordRecord, Boolean> BATCHING_REQUESTED = createField(
			DSL.name("batching_requested"), SQLDataType.BOOLEAN, this, "");

	/**
	 * The column <code>public.mas_job_record.error</code>.
	 */
	public final TableField<MasJobRecordRecord, ErrorCode> ERROR = createField(DSL.name("error"),
			SQLDataType.VARCHAR.asEnumDataType(ErrorCode.class), this, "");

	/**
	 * The column <code>public.mas_job_record.expires_on</code>.
	 */
	public final TableField<MasJobRecordRecord, Instant> EXPIRES_ON = createField(DSL.name("expires_on"),
			SQLDataType.INSTANT.nullable(false), this, "");

	/**
	 * The column <code>public.mas_job_record.error_message</code>.
	 */
	public final TableField<MasJobRecordRecord, String> ERROR_MESSAGE = createField(DSL.name("error_message"),
