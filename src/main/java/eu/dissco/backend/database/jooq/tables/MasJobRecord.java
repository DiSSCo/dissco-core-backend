...
public class MasJobRecord extends TableImpl<MasJobRecordRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function12<? super String, ? super JobState, ? super String, ? super Instant, ? super Instant, ? super JSONB, ? super String, ? super String, ? super MjrTargetType, ? super Boolean, ? super Object, ? super Instant, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function12<? super String, ? super JobState, ? super String, ? super Instant, ? super Instant, ? super JSONB, ? super String, ? super String, ? super MjrTargetType, ? super Boolean, ? super Object, ? super Instant, ? extends U> from) {
