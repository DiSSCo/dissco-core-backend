...
public class NewDigitalSpecimen extends TableImpl<NewDigitalSpecimenRecord> {
   ...
   */
  public final TableField<NewDigitalSpecimenRecord, String> ID = createField(DSL.name("id"),
      SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.new_digital_specimen.version</code>.
   */
  public final TableField<NewDigitalSpecimenRecord, Integer> VERSION = createField(
      DSL.name("version"), SQLDataType.INTEGER.nullable(false), this, "");

  /**
   * The column <code>public.new_digital_specimen.type</code>.
   */
  public final TableField<NewDigitalSpecimenRecord, String> TYPE = createField(DSL.name("type"),
      SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.new_digital_specimen.midslevel</code>.
   */
  public final TableField<NewDigitalSpecimenRecord, Short> MIDSLEVEL = createField(
   ...
   */
  public final TableField<NewDigitalSpecimenRecord, String> PHYSICAL_SPECIMEN_ID = createField(
   ...
   */
  public final TableField<NewDigitalSpecimenRecord, String> PHYSICAL_SPECIMEN_TYPE = createField(
   ...
   */
  public final TableField<NewDigitalSpecimenRecord, String> SPECIMEN_NAME = createField(
      DSL.name("specimen_name"), SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.new_digital_specimen.organization_id</code>.
   */
  public final TableField<NewDigitalSpecimenRecord, String> ORGANIZATION_ID = createField(
   ...
   */
  public final TableField<NewDigitalSpecimenRecord, String> PHYSICAL_SPECIMEN_COLLECTION = createField(
      DSL.name("physical_specimen_collection"), SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.new_digital_specimen.dataset</code>.
   */
  public final TableField<NewDigitalSpecimenRecord, String> DATASET = createField(
      DSL.name("dataset"), SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.new_digital_specimen.source_system_id</code>.
   */
  public final TableField<NewDigitalSpecimenRecord, String> SOURCE_SYSTEM_ID = createField(
      DSL.name("source_system_id"), SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.new_digital_specimen.created</code>.
   */
  public final TableField<NewDigitalSpecimenRecord, Instant> CREATED = createField(
      DSL.name("created"), SQLDataType.INSTANT.nullable(false), this, "");

  /**
   * The column <code>public.new_digital_specimen.last_checked</code>.
   */
  public final TableField<NewDigitalSpecimenRecord, Instant> LAST_CHECKED = createField(
      DSL.name("last_checked"), SQLDataType.INSTANT.nullable(false), this, "");

  /**
   * The column <code>public.new_digital_specimen.deleted</code>.
   */
  public final TableField<NewDigitalSpecimenRecord, Instant> DELETED = createField(
      DSL.name("deleted"), SQLDataType.INSTANT, this, "");

  /**
   * The column <code>public.new_digital_specimen.data</code>.
   */
  public final TableField<NewDigitalSpecimenRecord, JSONB> DATA = createField(DSL.name("data"),
      SQLDataType.JSONB, this, "");

  /**
   * The column <code>public.new_digital_specimen.original_data</code>.
   */
  public final TableField<NewDigitalSpecimenRecord, JSONB> ORIGINAL_DATA = createField(
      DSL.name("original_data"), SQLDataType.JSONB, this, "");

  /**
   * The column <code>public.new_digital_specimen.dwca_id</code>.
   */
  public final TableField<NewDigitalSpecimenRecord, String> DWCA_ID = createField(
      DSL.name("dwca_id"), SQLDataType.CLOB, this, "");
  ...
  public <O extends Record> NewDigitalSpecimen(Table<O> child,
      ForeignKey<O, NewDigitalSpecimenRecord> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.asList(Indexes.NEW_DIGITAL_SPECIMEN_CREATED_IDX,
        Indexes.NEW_DIGITAL_SPECIMEN_ID_IDX, Indexes.NEW_DIGITAL_SPECIMEN_PHYSICAL_SPECIMEN_ID_IDX);
  }
  ...
  public <U> SelectField<U> mapping(
      Function17<? super String, ? super Integer, ? super String, ? super Short, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super Instant, ? super Instant, ? super Instant, ? super JSONB, ? super JSONB, ? super String, ? extends U> from) {
