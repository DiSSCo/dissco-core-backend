...
public class OrganisationDocumentRecord extends
    UpdatableRecordImpl<OrganisationDocumentRecord> implements
    Record5<String, String, String, String, JSONB> {
  ...
  @Override
  public OrganisationDocumentRecord values(String value1, String value2, String value3,
      String value4, JSONB value5) {
    value1(value1);
    value2(value2);
    value3(value3);
    value4(value4);
   ...
   */
  public OrganisationDocumentRecord(String organisationId, String documentId, String documentTitle,
      String documentType, JSONB document) {
    super(OrganisationDocument.ORGANISATION_DOCUMENT);
