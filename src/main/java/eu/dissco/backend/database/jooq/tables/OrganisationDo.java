...
public class OrganisationDo extends TableImpl<OrganisationDoRecord> {
   ...
   */
  public final TableField<OrganisationDoRecord, String> ID = createField(DSL.name("id"),
      SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.organisation_do.organisation_name</code>.
   */
  public final TableField<OrganisationDoRecord, String> ORGANISATION_NAME = createField(
      DSL.name("organisation_name"), SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.organisation_do.organisation_code</code>.
   */
  public final TableField<OrganisationDoRecord, String> ORGANISATION_CODE = createField(
      DSL.name("organisation_code"), SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.organisation_do.city</code>.
   */
  public final TableField<OrganisationDoRecord, String> CITY = createField(DSL.name("city"),
      SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.organisation_do.country</code>.
   */
  public final TableField<OrganisationDoRecord, String> COUNTRY = createField(DSL.name("country"),
      SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.organisation_do.country_code</code>.
   */
  public final TableField<OrganisationDoRecord, String> COUNTRY_CODE = createField(
      DSL.name("country_code"), SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.organisation_do.data</code>.
   */
  public final TableField<OrganisationDoRecord, JSONB> DATA = createField(DSL.name("data"),
  ...
  public <O extends Record> OrganisationDo(Table<O> child,
      ForeignKey<O, OrganisationDoRecord> key) {
  ...
  public <U> SelectField<U> mapping(
      Function7<? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super JSONB, ? extends U> from) {
