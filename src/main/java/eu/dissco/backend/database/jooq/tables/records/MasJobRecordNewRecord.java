...
public class MasJobRecordNewRecord extends UpdatableRecordImpl<MasJobRecordNewRecord> implements Record9<String, JobStates, String, Instant, Instant, JSONB, String, String, TargetTypes> {
     ...
     */
    public void setJobState(JobStates value) {
        set(1, value);
    }
     ...
     */
    public JobStates getJobState() {
        return (JobStates) get(1);
    }
    ...
    @Override
    public Row9<String, JobStates, String, Instant, Instant, JSONB, String, String, TargetTypes> valuesRow() {
    ...
    @Override
    public Field<TargetTypes> field9() {
    ...
    @Override
    public MasJobRecordNewRecord value2(JobStates value) {
        setJobState(value);
        return this;
    }
    ...
    @Override
    public MasJobRecordNewRecord value9(TargetTypes value) {
        setTargetType(value);
        return this;
    }

    @Override
    public MasJobRecordNewRecord values(String value1, JobStates value2, String value3, Instant value4, Instant value5, JSONB value6, String value7, String value8, TargetTypes value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MasJobRecordNewRecord(String jobId, JobStates jobState, String masId, Instant timeStarted, Instant timeCompleted, JSONB annotations, String targetId, String userId, TargetTypes targetType) {
        super(MasJobRecordNew.MAS_JOB_RECORD_NEW);
