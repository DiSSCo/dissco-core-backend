...
public class NewAnnotation extends TableImpl<NewAnnotationRecord> {
   ...
   */
  public final TableField<NewAnnotationRecord, String> ID = createField(DSL.name("id"),
      SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.new_annotation.version</code>.
   */
  public final TableField<NewAnnotationRecord, Integer> VERSION = createField(DSL.name("version"),
      SQLDataType.INTEGER.nullable(false), this, "");

  /**
   * The column <code>public.new_annotation.type</code>.
   */
  public final TableField<NewAnnotationRecord, String> TYPE = createField(DSL.name("type"),
      SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.new_annotation.motivation</code>.
   */
  public final TableField<NewAnnotationRecord, String> MOTIVATION = createField(
      DSL.name("motivation"), SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.new_annotation.target_id</code>.
   */
  public final TableField<NewAnnotationRecord, String> TARGET_ID = createField(
      DSL.name("target_id"), SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.new_annotation.target_field</code>.
   */
  public final TableField<NewAnnotationRecord, String> TARGET_FIELD = createField(
      DSL.name("target_field"), SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.new_annotation.target_body</code>.
   */
  public final TableField<NewAnnotationRecord, JSONB> TARGET_BODY = createField(
      DSL.name("target_body"), SQLDataType.JSONB.nullable(false), this, "");

  /**
   * The column <code>public.new_annotation.body</code>.
   */
  public final TableField<NewAnnotationRecord, JSONB> BODY = createField(DSL.name("body"),
      SQLDataType.JSONB.nullable(false), this, "");

  /**
   * The column <code>public.new_annotation.preference_score</code>.
   */
  public final TableField<NewAnnotationRecord, Integer> PREFERENCE_SCORE = createField(
      DSL.name("preference_score"), SQLDataType.INTEGER.nullable(false), this, "");

  /**
   * The column <code>public.new_annotation.creator</code>.
   */
  public final TableField<NewAnnotationRecord, String> CREATOR = createField(DSL.name("creator"),
      SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.new_annotation.created</code>.
   */
  public final TableField<NewAnnotationRecord, Instant> CREATED = createField(DSL.name("created"),
      SQLDataType.INSTANT.nullable(false), this, "");

  /**
   * The column <code>public.new_annotation.generator_id</code>.
   */
  public final TableField<NewAnnotationRecord, String> GENERATOR_ID = createField(
      DSL.name("generator_id"), SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.new_annotation.generator_body</code>.
   */
  public final TableField<NewAnnotationRecord, JSONB> GENERATOR_BODY = createField(
      DSL.name("generator_body"), SQLDataType.JSONB.nullable(false), this, "");

  /**
   * The column <code>public.new_annotation.generated</code>.
   */
  public final TableField<NewAnnotationRecord, Instant> GENERATED = createField(
      DSL.name("generated"), SQLDataType.INSTANT.nullable(false), this, "");

  /**
   * The column <code>public.new_annotation.last_checked</code>.
   */
  public final TableField<NewAnnotationRecord, Instant> LAST_CHECKED = createField(
      DSL.name("last_checked"), SQLDataType.INSTANT.nullable(false), this, "");

  /**
   * The column <code>public.new_annotation.deleted</code>.
   */
  public final TableField<NewAnnotationRecord, Instant> DELETED = createField(DSL.name("deleted"),
  ...
  public <U> SelectField<U> mapping(
      Function16<? super String, ? super Integer, ? super String, ? super String, ? super String, ? super String, ? super JSONB, ? super JSONB, ? super Integer, ? super String, ? super Instant, ? super String, ? super JSONB, ? super Instant, ? super Instant, ? super Instant, ? extends U> from) {
