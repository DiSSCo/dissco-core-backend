...
public class Indexes {
  ...
  public static final Index ANNOTATION_HASH_IDX = Internal.createIndex(
      DSL.name("annotation_hash_idx"), Annotation.ANNOTATION,
      new OrderField[]{Annotation.ANNOTATION.ANNOTATION_HASH}, false);
  ...
  public static final Index ANNOTATION_STATUS_INDEX = Internal.createIndex(
      DSL.name("annotation_status_index"), Annotation.ANNOTATION,
      new OrderField[]{Annotation.ANNOTATION.TARGET_ID, Annotation.ANNOTATION.ANNOTATION_STATUS},
      false);
