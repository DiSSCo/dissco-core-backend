...
public class NewDigitalSpecimenRecord extends
    UpdatableRecordImpl<NewDigitalSpecimenRecord> implements
    Record17<String, Integer, String, Short, String, String, String, String, String, String, String, Instant, Instant, Instant, JSONB, JSONB, String> {
  ...
  @Override
  public NewDigitalSpecimenRecord values(String value1, Integer value2, String value3, Short value4,
      String value5, String value6, String value7, String value8, String value9, String value10,
      String value11, Instant value12, Instant value13, Instant value14, JSONB value15,
      JSONB value16, String value17) {
    value1(value1);
    value2(value2);
    value3(value3);
    value4(value4);
   ...
   */
  public NewDigitalSpecimenRecord(String id, Integer version, String type, Short midslevel,
      String physicalSpecimenId, String physicalSpecimenType, String specimenName,
      String organizationId, String physicalSpecimenCollection, String dataset,
      String sourceSystemId, Instant created, Instant lastChecked, Instant deleted, JSONB data,
      JSONB originalData, String dwcaId) {
    super(NewDigitalSpecimen.NEW_DIGITAL_SPECIMEN);
