...
public class OrganisationDoRecord extends UpdatableRecordImpl<OrganisationDoRecord> implements
    Record7<String, String, String, String, String, String, JSONB> {
  ...
  @Override
  public OrganisationDoRecord values(String value1, String value2, String value3, String value4,
      String value5, String value6, JSONB value7) {
    value1(value1);
    value2(value2);
    value3(value3);
    value4(value4);
   ...
   */
  public OrganisationDoRecord(String id, String organisationName, String organisationCode,
      String city, String country, String countryCode, JSONB data) {
    super(OrganisationDo.ORGANISATION_DO);
