...
public class Keys {
    ...
    public static final UniqueKey<NewUserRecord> NEW_USER_ORCHID_KEY = Internal.createUniqueKey(NewUser.NEW_USER, DSL.name("new_user_orchid_key"), new TableField[] { NewUser.NEW_USER.ORCHID }, true);
