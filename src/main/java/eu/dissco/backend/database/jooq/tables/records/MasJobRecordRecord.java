...
public class MasJobRecordRecord extends UpdatableRecordImpl<MasJobRecordRecord> implements Record12<String, JobState, String, Instant, Instant, JSONB, String, String, MjrTargetType, Boolean, Object, Instant> {
    ...
    @Override
    public Row12<String, JobState, String, Instant, Instant, JSONB, String, String, MjrTargetType, Boolean, Object, Instant> fieldsRow() {
        return (Row12) super.fieldsRow();
    }

    @Override
    public Row12<String, JobState, String, Instant, Instant, JSONB, String, String, MjrTargetType, Boolean, Object, Instant> valuesRow() {
    ...
    @Override
    public MasJobRecordRecord values(String value1, JobState value2, String value3, Instant value4, Instant value5, JSONB value6, String value7, String value8, MjrTargetType value9, Boolean value10, Object value11, Instant value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MasJobRecordRecord(String jobId, JobState jobState, String masId, Instant timeStarted, Instant timeCompleted, JSONB annotations, String targetId, String userId, MjrTargetType targetType, Boolean batchingRequested, Object error, Instant timeToLive) {
        super(MasJobRecord.MAS_JOB_RECORD);
