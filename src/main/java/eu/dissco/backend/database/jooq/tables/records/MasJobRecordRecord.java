...
public class MasJobRecordRecord extends UpdatableRecordImpl<MasJobRecordRecord> implements Record12<String, MjrJobState, String, Instant, Instant, JSONB, String, String, MjrTargetType, Boolean, Integer, ErrorCode> {
    ...
    @Override
    public Row12<String, MjrJobState, String, Instant, Instant, JSONB, String, String, MjrTargetType, Boolean, Integer, ErrorCode> valuesRow() {
    ...
    @Override
    public Field<ErrorCode> field12() {
    ...
    @Override
    public MasJobRecordRecord value11(Integer value) {
        setTimeToLive(value);
        return this;
    }

    @Override
    public MasJobRecordRecord value12(ErrorCode value) {
        setError(value);
        return this;
    }

    @Override
    public MasJobRecordRecord values(String value1, MjrJobState value2, String value3, Instant value4, Instant value5, JSONB value6, String value7, String value8, MjrTargetType value9, Boolean value10, Integer value11, ErrorCode value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MasJobRecordRecord(String jobId, MjrJobState jobState, String masId, Instant timeStarted, Instant timeCompleted, JSONB annotations, String targetId, String userId, MjrTargetType targetType, Boolean batchingRequested, Integer timeToLive, ErrorCode error) {
        super(MasJobRecord.MAS_JOB_RECORD);
