...
public class MasJobRecordRecord extends UpdatableRecordImpl<MasJobRecordRecord> implements Record8<String, String, String, Instant, Instant, JSONB, String, String> {
    ...
    @Override
    public Row8<String, String, String, Instant, Instant, JSONB, String, String> valuesRow() {
    ...
    @Override
    public MasJobRecordRecord values(String value1, String value2, String value3, Instant value4, Instant value5, JSONB value6, String value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MasJobRecordRecord(String jobId, String state, String creatorId, Instant timeStarted, Instant timeCompleted, JSONB annotations, String targetId, String userId) {
        super(MasJobRecord.MAS_JOB_RECORD);
