...
public class MasJobRecordRecord extends UpdatableRecordImpl<MasJobRecordRecord> implements Record7<UUID, AnnotationState, String, Instant, Instant, JSONB, String> {
     ...
     */
    public void setState(AnnotationState value) {
        set(1, value);
    }
    ...
    @Override
    public Row7<UUID, AnnotationState, String, Instant, Instant, JSONB, String> fieldsRow() {
        return (Row7) super.fieldsRow();
    }

    @Override
    public Row7<UUID, AnnotationState, String, Instant, Instant, JSONB, String> valuesRow() {
    ...
    @Override
    public Field<AnnotationState> field2() {
    ...
    @Override
    public AnnotationState component2() {
        return getState();
    }
    ...
    @Override
    public MasJobRecordRecord value2(AnnotationState value) {
        setState(value);
        return this;
    }
    ...
    @Override
    public MasJobRecordRecord values(UUID value1, AnnotationState value2, String value3, Instant value4, Instant value5, JSONB value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MasJobRecordRecord(UUID jobId, AnnotationState state, String creatorId, Instant timeStarted, Instant timeCompleted, JSONB annotations, String targetId) {
        super(MasJobRecord.MAS_JOB_RECORD);
