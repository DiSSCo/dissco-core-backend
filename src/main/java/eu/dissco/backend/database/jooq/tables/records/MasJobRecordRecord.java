...
public class MasJobRecordRecord extends UpdatableRecordImpl<MasJobRecordRecord> implements Record11<String, MjrJobState, String, Instant, Instant, JSONB, String, String, MjrTargetType, Boolean, Integer> {
    ...
    @Override
    public Row11<String, MjrJobState, String, Instant, Instant, JSONB, String, String, MjrTargetType, Boolean, Integer> valuesRow() {
    ...
    @Override
    public MasJobRecordRecord values(String value1, MjrJobState value2, String value3, Instant value4, Instant value5, JSONB value6, String value7, String value8, MjrTargetType value9, Boolean value10, Integer value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MasJobRecordRecord(String jobId, MjrJobState jobState, String masId, Instant timeStarted, Instant timeCompleted, JSONB annotations, String targetId, String userId, MjrTargetType targetType, Boolean batchingRequested, Integer timeToLive) {
        super(MasJobRecord.MAS_JOB_RECORD);
