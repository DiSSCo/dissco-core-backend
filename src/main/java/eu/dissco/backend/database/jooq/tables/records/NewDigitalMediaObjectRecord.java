...
public class NewDigitalMediaObjectRecord extends
    UpdatableRecordImpl<NewDigitalMediaObjectRecord> implements
    Record13<String, Integer, String, String, String, String, String, Instant, Instant, Instant, JSONB, JSONB, String> {
  ...
  @Override
  public NewDigitalMediaObjectRecord values(String value1, Integer value2, String value3,
      String value4, String value5, String value6, String value7, Instant value8, Instant value9,
      Instant value10, JSONB value11, JSONB value12, String value13) {
    value1(value1);
    value2(value2);
    value3(value3);
    value4(value4);
   ...
   */
  public NewDigitalMediaObjectRecord(String id, Integer version, String type,
      String digitalSpecimenId, String mediaUrl, String format, String sourceSystemId,
