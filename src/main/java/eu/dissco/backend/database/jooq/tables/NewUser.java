...
public class NewUser extends TableImpl<NewUserRecord> {
   ...
   */
  public final TableField<NewUserRecord, String> ID = createField(DSL.name("id"),
      SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.new_user.first_name</code>.
   */
  public final TableField<NewUserRecord, String> FIRST_NAME = createField(DSL.name("first_name"),
      SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.new_user.last_name</code>.
   */
  public final TableField<NewUserRecord, String> LAST_NAME = createField(DSL.name("last_name"),
      SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.new_user.email</code>.
   */
  public final TableField<NewUserRecord, String> EMAIL = createField(DSL.name("email"),
      SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.new_user.orcid</code>.
   */
  public final TableField<NewUserRecord, String> ORCID = createField(DSL.name("orcid"),
      SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.new_user.organization</code>.
   */
  public final TableField<NewUserRecord, String> ORGANIZATION = createField(
      DSL.name("organization"), SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.new_user.created</code>.
   */
  public final TableField<NewUserRecord, Instant> CREATED = createField(DSL.name("created"),
      SQLDataType.INSTANT.nullable(false), this, "");

  /**
   * The column <code>public.new_user.updated</code>.
   */
  public final TableField<NewUserRecord, Instant> UPDATED = createField(DSL.name("updated"),
      SQLDataType.INSTANT.nullable(false), this, "");
  ...
  public <U> SelectField<U> mapping(
      Function8<? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super Instant, ? super Instant, ? extends U> from) {
