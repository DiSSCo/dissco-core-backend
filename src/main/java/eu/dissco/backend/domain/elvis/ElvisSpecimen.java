...
@Schema(description = """
		...
		""")
public record ElvisSpecimen(@Schema(description = "dcterms:identifier, the DOI of the specimen") String inventoryNumber,
		...
		@JsonProperty(value = "URI") @Schema(
				description = "DOI that resolves to human-readable specimen landing page on DiSSCo") String uri,
		...
		@Schema(description = "dwc:family") String family, @Schema(description = "dwc:genus") String genus,
