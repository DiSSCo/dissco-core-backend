...
public enum TaxonMappingTerms implements MappingTerm {
	...
	KINGDOM("kingdom", "ods:hasIdentifications.ods:hasTaxonIdentifications.dwc:kingdom.keyword"),
	PHYLUM("phylum", "ods:hasIdentifications.ods:hasTaxonIdentifications.dwc:phylum.keyword"),
	CLASS("class", "ods:hasIdentifications.ods:hasTaxonIdentifications.dwc:class.keyword"),
	ORDER("order", "ods:hasIdentifications.ods:hasTaxonIdentifications.dwc:order.keyword"),
	FAMILY("family", "ods:hasIdentifications.ods:hasTaxonIdentifications.dwc:family.keyword"),
	GENUS("genus", "ods:hasIdentifications.ods:hasTaxonIdentifications.dwc:genus.keyword"),
