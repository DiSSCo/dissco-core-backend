...
@Schema
public record AggregationResponse(AggregationResponseData data,
		@Schema(description = "Links object, self-referencing") JsonApiLinks links) {

	@Schema
	private record AggregationResponseData(@Parameter(description = "ID of the response") String id,
