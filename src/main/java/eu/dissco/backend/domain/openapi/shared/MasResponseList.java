...
@Schema
public record MasResponseList(List<MasResponseData> data,
	...
	@Schema
	private record MasResponseData(@Schema(description = "ID of the resource") String id,
			@Schema(description = "Type of the resource") String type, MachineAnnotationService attributes) {
