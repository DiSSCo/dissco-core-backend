...
public record BatchAnnotationCountRequest(
	...
	public record BatchAnnotationCountRequestData(
		...
		@Schema
		public record BatchAnnotationCountRequestAttributes(BatchMetadata batchMetadata, @Schema(
				description = "Type of target, either https://doi.org/21.T11148/894b1e6cad57e921764e (digital specimen) or https://doi.org21.T11148/bbad8c4e101e8af01115 (digital media)") AnnotationTargetType annotationTargetType) {
